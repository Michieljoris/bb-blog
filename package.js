...
module.exports = {
    ...
    "homepage": "https://github.com/michieljoris/bb-blog",
    ...
    "repository": {
        "type": "git",
        "url": "https://github.com/michieljoris/bb-blog.git"
    },
    ...
    "licenses": [
        {
            "type": "MIT",
            "url": "http://github.com/michieljoris/bb-blog/blob/master/LICENSE.txt"
        }
    ],
    ...
    //Installs a binary script called bb-blog which is linked to
    //./bin/bb-blog in the local package.

    //If we have installed this package globally using npm install bb-blog
    //-g we will be able to call this new command bb-blog from anywhere on
    //our system.
    "bin": {
	// "commit": "bin/bb-blog.js"
    },
    ...
    "scripts": {
        ...
        "docs": "node node_modules/.bin/docco src/bb-blog.js"
    }
};
